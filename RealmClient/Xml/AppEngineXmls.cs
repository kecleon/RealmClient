...
public class Account { 
	...
	[XmlElement(ElementName="HasGifts")] 
	public object HasGifts { get; set; } 
...
public class AppSettings { 
	...
	[XmlElement(ElementName="BuildId")] 
	...
	[XmlElement(ElementName="BuildCDN")] 
	public string BuildCDN { get; set; } 
...
// using System.Xml.Serialization;
// XmlSerializer serializer = new XmlSerializer(typeof(Chars));
// using (StringReader reader = new StringReader(xml))
// {
//    var test = (Chars)serializer.Deserialize(reader);
// }
...
public class Char { 
	...
	[XmlElement(ElementName="Seasonal")] 
	...
	[XmlElement(ElementName="EquipQS")] 
	...
	[XmlElement(ElementName="PCStats")] 
	...
	public double Titles { get; set; } 

	[XmlElement(ElementName="XpBoosted")] 
	public int XpBoosted { get; set; } 

	[XmlElement(ElementName="XpTimer")] 
	public int XpTimer { get; set; } 

	[XmlElement(ElementName="LDTimer")] 
	public int LDTimer { get; set; } 

	[XmlElement(ElementName="LTTimer")] 
	...
	[XmlElement(ElementName="Tex1")] 
	public int Tex1 { get; set; } 

	[XmlElement(ElementName="Tex2")] 
...
public class ItemCosts { 
	...
	[XmlElement(ElementName="ItemCost")] 
...
public class MysteryBox { 
	...
	[XmlElement(ElementName="Jackpots")] 
...
public class Package { 
	...
	[XmlElement(ElementName="CharSlot")] 
...
public class ClassPowerup { 
	...
	[XmlElement(ElementName="Spd")] 
	public int Spd { get; set; } 

	[XmlElement(ElementName="Vit")] 
